    ...
    <div className="min-h-screen bg-gray-100 text-gray-900">
      <header className="p-4 flex justify-between items-center bg-white shadow">
        <div className="flex items-center gap-2">
          <Scale className="h-6 w-6" style={{ color: BRAND }} />
      ...
      <main className="text-center py-20">
        <h2 className="text-4xl font-semibold">Defensa estratégica y soluciones legales claras</h2>
        <p className="mt-4">Civil • Penal • Laboral • Saneamiento Físico-Legal</p>
